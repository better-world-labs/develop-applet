    ...
    <n-layout has-sider>
      <n-layout-sider :width="296">
        <n-menu
          class="menu"
          :options="menuOptions"
          :value="applicationStore.currentMenu"
          :default-value="applicationStore.currentMenu"
...
<script lang="ts" setup>
  ...
  function renderIcon(name: string, str: string, activeIcon: string) {
    return () =>
      h(IconFontSymbol, {
        size: 30,
        name: name == applicationStore.currentMenu ? activeIcon : str,
      });
  }
  ...
  const menuOptions: MenuOption[] = [
    {
      ...
      icon: renderIcon(
        'home',
        'icon-icon-xiaochengxuguangchang-moren',
        'icon-icon-xiaochengxuguangchang-xuanzhong'
      ),
    },
    {
      ...
      icon: renderIcon(
        'small-program',
        'icon-icon-wodexiaochengxu-moren',
        'icon-icon-wodexiaochengxu-xuanzhong'
      ),
    },
    {
      label: '我参与的',
      ...
      icon: renderIcon(
        'my-participation',
        'icon-icon-wocanyude-moren',
        'icon-icon-wodejifen-xuanzhong'
      ),
    },
    {
