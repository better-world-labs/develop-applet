  ...
  <div class="builder">
    <header>
      ...
      <div class="right-btn">
        ...
        <n-popover trigger="click" :show-arrow="false" placement="bottom-end" style="border-radius: 12px; box-shadow: 2px 2px 19px -5px rgba(127, 124, 132, 0.3);
                          padding: 16px 16px 10px 16px;">
          <template #trigger>
            <div class="solution" @click="solutionBtn">如何创建小程序？</div>
          </template>
          <video style="width: 432px;border-radius: 8px;border: 1px solid rgba(0, 0, 0, 0.1);" autoplay loop
