...
<template>
  <div>
    ...
    <div class="my-smallmp">
      <n-tabs type="line" @update:value="updateTab" :default-value="applicationStore.mineAppCurrentTab">
        <n-tab-pane v-for="item in tabList" :name="item.order" :tab="item.name" :key="item.name">
